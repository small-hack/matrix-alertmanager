...
This project was originally created by [Jason Robinson](https://jasonrobinson.me) at [jaywink/matrix-alertmanager](https://github.com/jaywink/matrix-alertmanager), and then it was forked by [beeper/matrix-alertmanager](https://github.com/beeper/matrix-alertmanager) but they didn't add their own copyright notice, and then finally we, [@small-hack](https://github.com/small-hack), forked it as well and it's now maintained by us.

We'll try to also create some PRs to update the other codebases as well :)
